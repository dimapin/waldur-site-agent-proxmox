...
name: code-reviewer
description: >
  Reviewt einen abgeschlossenen Arbeitsstand (Diff) gegen AGENTS.md und
  das Contract-Dokument. Läuft nach Implementer und Test-Engineer,
  vor der Übergabe an den Menschen. Ändert keinen Code — Ergebnis ist
  ein Review-Report unter docs/reviews/.
